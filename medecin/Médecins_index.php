    ...
    <nav>
        <ul class='nav-bar'>
            ...
            <span class="menu">
                ...
                <li><a href="../medecin/Médecins_index">Médecin</a></li>
...
if (isset($_SESSION['convention-update'])) {
  ...
  unset($_SESSION['convention-update']);
    ...
    <div class="divv"><a href="Médecins_add" class="btn-add">Add a Médecin </a></div>
...
<table class="content-table">
  ...
  <tr>
       ...
       <td class="options">
        ...
        <a  href="medecin_delete.php?id=<?php echo $medecin_id ?>&imagename=<?php echo $imagename  ?>" class="btn-delete">delete </a>  
          </td>    
